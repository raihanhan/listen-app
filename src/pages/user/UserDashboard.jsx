                            ...
                            return (
                                <div key={index}>
                                    {order.cartItems.map((item, index) => {
                                        ...
                                        const {id,title, price, eventImageUrl, date} = item
                                                    ...
                                                    <div className="p-8">
                                                        <div className="grid grid-cols-2 sm:grid-cols-4 md:grid-cols-1">
                                                            ...
                                                            <div className="mb-4">
                                                                ...
                                                                <div className="text-sm font-medium text-gray-900">Rp.{price }</div>
                                                            </div>
                                                        ...
                                                        <ul className="-my-7 divide-y divide-gray-200">
                                                            ...
                                                            >
                                                                ...
                                                                <div className="ml-auto flex flex-col items-end justify-between">
                                                                    <p className="text-right text-sm font-bold text-gray-900">Rp. {price}</p>
                                                                </div>
                                                            </li>
                                                        </ul>
